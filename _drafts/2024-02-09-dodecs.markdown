...
With this in mind, it follows that we can avoid progagating numerical errors in the calculation of vertices' positions, fixing the problem posed by the first question, if:
...
This basis is $\left\\{1, \varphi, \varphi^2, \varphi^3 \right\\}$ and this picture show how you can obtain $\nu$ with it:
...
\left(x_0,y_0,z_0,w_0\right) \cdot \left(x_1,y_1,z_1,w_1\right) = \left(,,,\right)
